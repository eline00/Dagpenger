...
public class Dagpenger {
    ...
    private double income1 = 0,
            income2 = 0,
            income3 = 0;       // inntekter per kalenderårene
    ...
    public boolean qualified() {
        ...
        if (income3 == 0) {     // må ha hatt arbeidsinntekt minst det siste kalenderåret
            ...
            return !(totalIncome < 3 * G) && !(income2 < 1.5 * G);
        }
    }
    ...
    public int dailyRate() {
        ...
        // dagpengegrunnlaget er høyeste verdi av enten intekten siste året, eller gjennomsnittet av de 3 siste årene
    ...
    public static void main(String[] args)
    {
        ...
        System.out.print("Enter first income- ");
        int a = sc.nextInt();
        System.out.print("Enter second income- ");
        int b = sc.nextInt();
        System.out.print("Enter third income- ");
        int c = sc.nextInt();
